<div class="campo">
    ...
    <input 
        ...
        name="cliente"
        value="<?php echo $servicio->cliente; ?>"
    >
</div>
...
<div class="campo">
    ...
    <input 
        ...
        name="numero_parte"
        value="<?php echo $servicio->numero_parte; ?>"
    >
</div>
...
<div class="campo">
    ...
    <input 
        type="text"
        id="descripcion"
        placeholder="descripcion de pieza"
        name="descripcion_pieza"
        value="<?php echo $servicio->descripcion_pieza; ?>"
    >
</div>
...
<div class="campo">
    ...
    <input 
        ...
        name="numero_dibujo"
        value="<?php echo $servicio->numero_dibujo; ?>"
    >
</div>
...
<div class="campo">
    ...
    <input 
        ...
        value="<?php echo $servicio->cantidad_piezas; ?>"
    >
</div>
...
<div class="campo">
    ...
    <input 
        ...
        name="ubicacion"
        value="<?php echo $servicio->ubicacion; ?>"
    >
</div>
...
<div class="campo">
    ...
    <input 
        ...
        name="tipo_material"
        value="<?php echo $servicio->tipo_material; ?>"
    >
</div>